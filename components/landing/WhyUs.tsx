    ...
    <section id="features" className="py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-[#4A7C59] font-semibold text-sm uppercase tracking-wider">Why BitCense</span>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="bg-white rounded-2xl p-8 border border-gray-100 hover:border-[#4A7C59]/20 hover:shadow-xl hover:shadow-[#4A7C59]/5 transition-all duration-300"
            >
              <div className="w-14 h-14 bg-[#4A7C59]/10 rounded-xl flex items-center justify-center text-[#4A7C59] mb-6">
                {feature.icon}
              </div>
