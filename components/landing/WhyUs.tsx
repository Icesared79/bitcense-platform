export function WhyUs() {
  ...
  return (
    <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 bg-[#f8fafc] relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute top-1/4 right-0 w-72 h-72 bg-[#4A7C59]/5 rounded-full blur-3xl" />
      <div className="absolute bottom-1/4 left-0 w-72 h-72 bg-[#0f172a]/5 rounded-full blur-3xl" />
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:border-gray-300 transition-all duration-300 hover:-translate-y-1"
            >
              <div className={`w-12 h-12 ${feature.iconBg} rounded-xl flex items-center justify-center text-white mb-4 shadow-md`}>
                {feature.icon}
              </div>
