      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              BitCense provides professional asset qualification services to help businesses
              secure the financing they need to grow.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <p className="text-gray-500 text-xs mt-4 text-center md:text-left">
            Disclaimer: BitCense provides asset qualification services for informational purposes.
            Final financing decisions are made by lending institutions.
          </p>
        </div>
      </div>
    </footer>
