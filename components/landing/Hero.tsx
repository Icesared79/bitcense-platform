        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Get Your Assets{' '}
              <span className="text-blue-600">Qualified</span> for Financing
            </h1>
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              BitCense streamlines the asset qualification process. Submit your assets,
              track progress in real-time, and receive expert feedback — all in one platform.
            </p>
